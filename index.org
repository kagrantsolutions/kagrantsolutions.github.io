...
#+HTML_HEAD:   /* 1. Target the precise selector string Bigblow uses for links */
#+HTML_HEAD:   div#table-of-contents div#text-table-of-contents ul li a,
#+HTML_HEAD:   #text-table-of-contents ul li a,
#+HTML_HEAD:   #table-of-contents a {
#+HTML_HEAD:     font-size: 11px !important;    /* Forces text smaller on narrow screens */
#+HTML_HEAD:     line-height: 1.2 !important;
#+HTML_HEAD:     padding: 4px 6px !important;   /* Shrinks the padding footprint */
#+HTML_HEAD:     white-space: normal !important;
#+HTML_HEAD:     display: inline-block !important;
#+HTML_HEAD:   }
#+HTML_HEAD:
#+HTML_HEAD:   /* 2. Target the exact path for the ToC Header element */
#+HTML_HEAD:   div#table-of-contents h2,
#+HTML_HEAD:   #table-of-contents h2 {
#+HTML_HEAD:     font-size: 14px !important;    /* Shrinks down the title text */
#+HTML_HEAD:     margin-top: 5px !important;
#+HTML_HEAD:     margin-bottom: 5px !important;
#+HTML_HEAD:   }
#+HTML_HEAD:
#+HTML_HEAD:   /* 3. Pull in list indents to prevent clipping */
#+HTML_HEAD:   #table-of-contents ul {
#+HTML_HEAD:     padding-left: 10px !important;
#+HTML_HEAD:     margin-left: 0 !important;
#+HTML_HEAD:   }
#+HTML_HEAD: }
#+HTML_HEAD: </style>
