...
#+HTML_HEAD:   #table-of-contents {
#+HTML_HEAD:     font-size: 13px !important;  /* Drops the font scale down from ~16px/18px */
#+HTML_HEAD:     line-height: 1.3 !important;
#+HTML_HEAD:   }
#+HTML_HEAD:
#+HTML_HEAD:   #table-of-contents h2 {
#+HTML_HEAD:     font-size: 16px !important;  /* Shrinks the main "Table of Contents" title */
...
#+HTML_HEAD:     font-size: 13px !important;   /* Tight font to stop unintended line wrapping */
