...
@media screen and (max-width: 768px) {
    /* 2. Completely crush the desktop layout sidebar styles */
    #table-of-contents {
    ...
    /* 3. Strip list margins so "Work With Us" stays on its single line */
    ...
    /* 4. Transform links into explicit full-width touch areas */
    #text-table-of-contents a,
    #table-of-contents a {
        display: inline-block !important;
    ...
    /* 5. Force clear layout layers trapping phone-tap interactions */
    #toggle-sidebar,
    .org-nav-box,
    #postamble,
    .footer {
    ...
    /* 6. Push document body content text below the newly stacked ToC block */
    #content {
        margin-left: 0 !important;
        width: 100% !important;
        padding: 15px !important;
